...
runCase('supported mention rendering still produces expected badges and labels', () => {
  ...
  assertEqual(textOf(elementAt(elements, 0)), '@writing-code-prin...', 'skill badge label should truncate visually')
  assertEqual(elementAt(elements, 0).props.title, '@writing-code-principles', 'skill badge title should preserve full label')
