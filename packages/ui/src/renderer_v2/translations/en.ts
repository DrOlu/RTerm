export const en = {
  ...
  settings: {
    ...
    tooltips: {
      ...
      commandDraftShortcut: 'Click the shortcut field to record a binding for opening Command Draft in terminal tabs. Press Esc while recording to disable the shortcut entirely.',
      ...
      compactionModel: 'Used only for history compaction summaries. If any configured model in this profile does not support images, all model invocations in the profile will receive image-free history. Prefer a Compaction Model whose maxTokens is greater than or equal to the Global Model.',
