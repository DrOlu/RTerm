export const zh = {
  ...
  filesystem: {
    ...
    fullPathCopied: "已复制完整路径。",
    fullPathsCopied: (count: number) => `已复制 ${count} 个完整路径。`,
    copyFullPathFailed: "复制完整路径失败。",
    ...
    transferSummaryRunning: (count: number) => `${count} 进行中`,
    transferSummaryScanning: (count: number) => `${count} 扫描中`,
    transferSummaryQueued: (count: number) => `${count} 排队中`,
    transferSummaryBackground: (count: number) => `${count} 后台`,
    transferSummaryRecent: (count: number) => `${count} 最近完成`,
    transferSectionCurrent: "当前 Tab",
    transferSectionBackground: "后台",
    transferSectionRecent: "最近",
    transferCopyKind: "复制",
    transferMoveKind: "剪切",
    transferAgentOrigin: "AGENT",
    transferUserOrigin: "用户",
    transferQueued: "排队中",
    transferScanning: "扫描中",
    transferRunning: "进行中",
    transferCompleted: "已完成",
    transferCancelled: "已取消",
    transferCancelling: "正在取消...",
    transferFailed: "失败",
    transferWaitingForSlot: "等待传输通道",
    cancelTransfer: "取消传输",
    pasteConflictTitle: "检测到同名文件",
    pasteConflictMessage: (count: number, namesPreview: string) =>
      `目标目录存在 ${count} 个同名项：${namesPreview}。请选择覆盖，或保留两者并自动添加数字后缀。`,
  ...
  fileEditor: {
    ...
    previewErrorFallback: "该文件暂不支持预览。",
    loadingPdf: "正在加载 PDF...",
    renderingPdfPage: "正在渲染页面...",
    previousPdfPage: "上一页",
    nextPdfPage: "下一页",
    zoomIn: "放大",
    zoomOut: "缩小",
  ...
  layout: {
    ...
    openListPanel: "打开标签列表",
    emptyTerminalTabs: "暂无终端标签",
    emptyChatTabs: "暂无聊天标签",
    listPanelChatMessages: (count: number) => `${count} 条消息`,
    listPanelChatRunning: "运行中",
    listPanelChatReady: "就绪",
    noHostPanel: "当前布局无宿主面板",
